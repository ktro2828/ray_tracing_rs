...
impl Renderer for Scene {
    ...
    fn render_aa(&self, samples: usize) -> RgbImage {
        ...
        img.enumerate_pixels_mut()
            ...
            .par_iter_mut()
            .for_each(|(x, y, pixel)| {
                let mut px_color = (0..samples).into_iter().fold(Color::BLACK, |acc, _| {
                    let r = Vec3::rand();
